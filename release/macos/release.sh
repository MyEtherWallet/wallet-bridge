...
INSTALLER=wallet-bridge-$VERSION.pkg
...
# second, make installer and add walletd and uninstaller
...
cp /release/build/walletd Applications/Utilities/Wallet\ Bridge/
cp ../../../uninstall.pkg Applications/Utilities/Wallet\ Bridge/
